    ...
    <div className="min-h-screen bg-[#08090a]">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-gradient-to-br from-muted/50 to-muted/20 border border-white/[0.06] rounded-3xl overflow-hidden">
            {/* Header */}
              ...
              >
                ...
                <div className="flex justify-center">
                  {typeof row.aiwholesail === 'boolean' ? (
                    row.aiwholesail ? (
                      ...
                      <X className="h-5 w-5 text-neutral-400/30" />
                    )
                  ) : (
                ...
                <div className="flex justify-center">
                  {typeof row.competitor === 'boolean' ? (
                    row.competitor ? (
                      <Check className="h-5 w-5 text-neutral-400/50" />
                    ) : (
                      <X className="h-5 w-5 text-neutral-400/30" />
                    )
                  ) : (
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {comp.aiwholesailAdvantages.map((adv, i) => (
              <div
                key={i}
                className="bg-gradient-to-br from-muted/50 to-muted/20 border border-white/[0.06] rounded-3xl p-7 hover:border-primary/20 transition-all duration-300"
              >
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {comp.weaknesses.map((w, i) => (
              <div
                key={i}
                className="bg-gradient-to-br from-muted/50 to-muted/20 border border-white/[0.06] rounded-3xl p-7 hover:border-red-500/10 transition-all duration-300"
              >
