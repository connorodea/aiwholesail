...
const plans = [
  {
    ...
    description: 'Everything you need to source and analyze deals',
    features: [
      '10 property searches per day',
      'Up to 5 alert locations',
      'AI property analysis — 10 / month',
      'AI photo condition analysis — 10 / month',
      'AI-ranked comps with reasoning — 25 / month',
      'Skip tracing — 25 lookups / month',
      'Buyer pitch PDFs — unlimited',
      'Webhooks — 3 endpoints',
      'Contracts, pipeline, sequences',
  ...
  },
  {
    ...
    description: 'Unlimited everything for serious professionals',
    features: [
      'Unlimited property searches',
      'Unlimited alert locations',
      'Real-time updates every 4 hours',
      'AI property analysis — unlimited',
      'AI photo condition analysis — unlimited',
      'AI-ranked comps with reasoning — unlimited',
      'Skip tracing — 200 lookups / month',
      'Buyer pitch PDFs — unlimited',
