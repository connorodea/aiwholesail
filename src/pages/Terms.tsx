    ...
    <PublicLayout>
      ...
      <section className="relative bg-gradient-to-b from-background via-card to-background text-foreground overflow-hidden">
        <div className="relative container mx-auto max-w-6xl px-4 pt-24 pb-20 text-center">
          <Badge className="mb-6 bg-foreground/10 text-foreground/80 border-foreground/10 backdrop-blur-sm text-xs font-medium px-4 py-1.5 rounded-full">
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-muted-foreground font-light leading-relaxed mb-3">You agree not to use the service to:</p>
              <ul className="list-disc pl-6 space-y-1.5 text-muted-foreground font-light leading-relaxed">
