...
import { Search, MapPin, User, Home, DollarSign, Calendar, Mail, Building, FileText, RefreshCw } from 'lucide-react';
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (propertyResults.length > 0 && propertyResults[0].address) {
        toast({ title: 'Property found', description: `${propertyResults.length} record(s) from county assessor data.` });
