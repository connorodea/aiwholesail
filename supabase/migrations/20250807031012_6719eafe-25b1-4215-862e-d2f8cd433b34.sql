-- Fix the ON CONFLICT issue by ensuring user_id is unique in subscribers table
-- First add unique constraint to user_id if it doesn't exist
ALTER TABLE public.subscribers 
ADD CONSTRAINT subscribers_user_id_unique UNIQUE (user_id);

-- Now safely insert test accounts
