...
// resolveTierFromPrice is imported from lib/tier-resolver.js — extracted so
// it's unit-testable without pulling the Stripe + Express stack into the
// test process. See test/lib/tier-resolver.test.js for the spec.
